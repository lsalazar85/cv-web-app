  ...
  Array(58).concat([
    ...
    function (n, t, e) {
      ...
      var c = e(0),
        ...
        r = i.a.createContext && i.a.createContext(a)
    },
    function (n, t, e) {
      'use strict'
      function c(n, t) {
          ...
          return i.a.createElement(
            ...
            i.a.createElement(
              ...
              i.a.createElement(a.c, {
                ...
                path: '/',
                render: function () {
                  return i.a.createElement(r.a, null)
                },
              }),
              i.a.createElement(a.c, {
                path: '/contact',
    ...
    function (n, t, e) {
      ...
      var c = e(0),
          ...
          introduction: [
            {
              id: 1,
              content:
                "I'm a Front End Developer with 5+ years of professional experience, \n            based in Buenos Aires - Argentina.",
            },
            {
              id: 2,
              content:
        ...
        g = [
          { id: 1, icon: i.a.createElement(o.h, null) },
          { id: 2, icon: i.a.createElement(o.m, null) },
          { id: 3, icon: i.a.createElement(a.h, null) },
          { id: 4, icon: i.a.createElement(o.l, null) },
          { id: 8, icon: i.a.createElement(r.d, null) },
          { id: 9, icon: i.a.createElement(o.g, null) },
          { id: 10, icon: i.a.createElement(o.d, null) },
          { id: 11, icon: i.a.createElement(o.n, null) },
          { id: 12, icon: i.a.createElement(o.i, null) },
          { id: 13, icon: i.a.createElement(o.b, null) },
          { id: 14, icon: i.a.createElement(r.a, null) },
          { id: 15, icon: i.a.createElement(o.e, null) },
        ],
        x = [
          { id: 1, icon: i.a.createElement(a.j, null) },
          { id: 2, icon: i.a.createElement(r.e, null) },
          { id: 3, icon: i.a.createElement(o.j, null) },
        ],
        z = [
          { id: 1, icon: i.a.createElement(o.a, null) },
          { id: 2, icon: i.a.createElement(r.f, null) },
          { id: 3, icon: i.a.createElement(o.c, null) },
          { id: 4, icon: i.a.createElement(o.k, null) },
          { id: 5, icon: i.a.createElement(o.f, null) },
          { id: 6, icon: i.a.createElement(a.b, null) },
          { id: 7, icon: i.a.createElement(a.c, null) },
          { id: 8, icon: i.a.createElement(o.o, null) },
          { id: 9, icon: i.a.createElement(o.p, null) },
          { id: 10, icon: i.a.createElement(a.e, null) },
          { id: 11, icon: i.a.createElement(r.c, null) },
          { id: 12, icon: i.a.createElement(r.b, null) },
        ],
        b = [
          {
            id: 1,
            icon: i.a.createElement(a.f, null),
          ...
          {
            id: 2,
            icon: i.a.createElement(u.a, null),
          ...
          {
            id: 3,
            icon: i.a.createElement(l.d, null),
          ...
          {
            id: 4,
            icon: i.a.createElement(d.a, null),
            title: 'Multi Devices',
            description:
              'I develop dedicated applications with an efficient and functional front-end.',
          },
        ...
        w = [
          { id: 1, icon: i.a.createElement(l.e, null) },
          { id: 2, icon: i.a.createElement(l.b, null) },
          { id: 3, icon: i.a.createElement(l.c, null) },
          { id: 4, icon: i.a.createElement(l.a, null) },
        ],
        M = function () {
          return i.a.createElement(
            p.a,
            ...
            i.a.createElement(
              ...
              null,
              v &&
                v.introduction.map(function (n) {
                  return i.a.createElement('p', { key: n.id }, n.content)
                })
            ),
            i.a.createElement(
              m.a,
            ...
            i.a.createElement(
              ...
              i.a.createElement(
                ...
                null,
                z.map(function (n) {
                  return i.a.createElement('li', { key: n.id }, n.icon)
                })
              )
            ),
            i.a.createElement(
    ...
    function (n, t, e) {
      ...
      function c(n) {
        return (
          n &&
          n.map(function (n, t) {
            return l.a.createElement(n.tag, d({ key: t }, n.attr), c(n.child))
          })
        )
      }
      function i(n) {
        return function (t) {
          return l.a.createElement(a, d({ attr: d({}, n.attr) }, t), c(n.child))
        }
      }
      function a(n) {
        var t = function (t) {
          ...
          return (
            ...
            l.a.createElement(
              ...
              a && l.a.createElement('title', null, a),
              n.children
            )
          )
        }
        return void 0 !== o.b
          ? l.a.createElement(o.b.Consumer, null, function (n) {
              return t(n)
            })
          : t(o.a)
      }
          ...
          function () {
            return (
              (d =
                Object.assign ||
                function (n) {
                  for (var t, e = 1, c = arguments.length; e < c; e++) {
                    t = arguments[e]
                    for (var i in t)
        ...
        u =
          ...
          function (n, t) {
            ...
            if (null != n && 'function' === typeof Object.getOwnPropertySymbols)
              for (
                var i = 0, c = Object.getOwnPropertySymbols(n);
                i < c.length;
                i++
              )
                t.indexOf(c[i]) < 0 &&
                  Object.prototype.propertyIsEnumerable.call(n, c[i]) &&
                  (e[c[i]] = n[c[i]])
            return e
          }
    },
    function (n, t, e) {
      ...
      ;(t.a = c), (t.b = i), (t.c = a), (t.d = r), (t.e = l), (t.f = o)
      var d = e(59)
    },
    function (n, t, e) {
      'use strict'
          ...
          return i.a.createElement(
            ...
            t &&
              i.a.createElement(
                'div',
                null,
                i.a.createElement(r.a, { minFontSize: l, maxFontSize: o }, a)
              ),
            e &&
              i.a.createElement(
                'div',
                null,
                i.a.createElement(r.b, { minFontSize: l, maxFontSize: o }, a)
              )
          )
        }
      ;(l.defaultProps = { h1: !1, h2: !1 }),
        (l.propTypes = {
          h1: a.bool,
          h2: a.bool,
          content: a.string.isRequired,
          minFontSize: a.string.isRequired,
          maxFontSize: a.string.isRequired,
        }),
        (t.a = l)
    },
    function (n, t, e) {
      ...
      var c = e(0),
        ...
        l = function (n) {
          ...
          return i.a.createElement(
            r.a,
            null,
            i.a.createElement(r.c, null, t),
            i.a.createElement(r.e, null, c),
            i.a.createElement(r.b, null, e)
          )
        }
      ;(l.propTypes = {
        icon: a.object.isRequired,
    ...
    function (n, t, e) {
      ...
      var c = e(1),
        ...
        r = c.c.main(a, Object(i.a)({ time: '400ms' }))
    },
    function (n, t, e) {
      'use strict'
      var c = e(0),
        ...
        o = e(95),
        d = [
          { id: 1, icon: i.a.createElement(l.a, null), url: '/' },
          { id: 2, icon: i.a.createElement(l.b, null), url: '/education' },
          {
            id: 3,
            icon: i.a.createElement(l.c, null),
            url: '/work-experience',
          },
          { id: 4, icon: i.a.createElement(r.a, null), url: '/contact' },
        ],
        u = function () {
          return i.a.createElement(
            o.b,
              ...
              i.a.createElement(
                ...
                d.map(function (n) {
                  return i.a.createElement(
                    'li',
                    { key: n.id },
                    i.a.createElement(a.b, { exact: !0, to: n.url }, n.icon)
                  )
                })
              )
            ),
            i.a.createElement(
              o.a,
              { position: 'flex-end', padddingBotton: 32 },
              i.a.createElement(l.d, null)
            )
          )
        }
      t.a = u
    ...
    function (n, t, e) {
      ...
      var c = e(0),
        ...
        u = [
          {
            id: 1,
            icon: i.a.createElement(a.d, null),
            url: 'https://www.instagram.com/lanzaroth.js/',
          },
          {
            id: 2,
            icon: i.a.createElement(a.g, null),
            url: 'https://www.linkedin.com/in/lsalazar85/',
          },
          {
            id: 3,
            icon: i.a.createElement(a.b, null),
            url: 'https://github.com/lsalazar85',
          },
        ],
        s = function () {
          return i.a.createElement(
            ...
            i.a.createElement(
              ...
              i.a.createElement('span', null, 'Front End Developer'),
              i.a.createElement(
                'ul',
                null,
                u.map(function (n) {
    ...
    function (n, t, e) {
      ...
      var c =
        'https://media-exp1.licdn.com/dms/image/C4E22AQHzRCT_oce8rw/feedshare-shrink_800/0/1617929879169?e=1634169600&v=beta&t=O57mOrZDe9xWpTFfO1tMSsG37UzrjYyYzhPbuuXaA8Q'
    },
    function (n, t, e) {
      'use strict'
      function c(n, t) {
...
//# sourceMappingURL=0.2430c33b.chunk.js.map
